...
@RestController
@RequestMapping("/api/xhmall-application-kafka")
public class XhmallApplicationKafkaResource {
    private final Logger log = LoggerFactory.getLogger(XhmallApplicationKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public XhmallApplicationKafkaResource(KafkaProperties kafkaProperties) {
